...
from utills.constants import PI, K0, Z0, MU_0, PI2, PLANCK_CONST_REDUCEDev, PI4, C
...
#
#         # return 1j * (K0(f) / Z0) * (
#         #             self.epsilon_effst(self.epsilon_r, self.sc_width, self.sc_height, self.sc_thickness) / g1)
#
#     def characteristic_impedance(self, Z, Y):
#         return cmath.sqrt(Z / Y)
#
